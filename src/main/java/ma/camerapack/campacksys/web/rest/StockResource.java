...
import ma.camerapack.campacksys.domain.Stock;
import ma.camerapack.campacksys.repository.StockRepository;
...
/**
 * REST controller for managing {@link ma.camerapack.campacksys.domain.Stock}.
 */
@RestController
@RequestMapping("/api")
