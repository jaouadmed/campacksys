...
export class DurationComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.durationService
      ...
      .subscribe(
        (res: HttpResponse<IDuration[]>) => this.paginateDurations(res.body, res.headers),
  ...
  trackId(index: number, item: IDuration) {
    return item.id;
  }
  ...
  protected paginateDurations(data: IDuration[], headers: HttpHeaders) {
