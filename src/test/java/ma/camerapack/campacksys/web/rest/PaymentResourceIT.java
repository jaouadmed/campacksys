...
public class PaymentResourceIT {
    ...
    private static final PaymentType DEFAULT_TYPE = PaymentType.ONE_TIME;
    private static final PaymentType UPDATED_TYPE = PaymentType.DIVIDED;

    private static final PaymentState DEFAULT_STATE = PaymentState.CREATED;
    private static final PaymentState UPDATED_STATE = PaymentState.ONGOING;

    private static final Double DEFAULT_TOTAL = 1D;
    private static final Double UPDATED_TOTAL = 2D;
    private static final Double SMALLER_TOTAL = 1D - 1D;

    private static final Double DEFAULT_REST = 1D;
    private static final Double UPDATED_REST = 2D;
    private static final Double SMALLER_REST = 1D - 1D;
    ...
    public void createPayment() throws Exception {
        ...
        assertThat(testPayment.getRest()).isEqualTo(DEFAULT_REST);
    }
    ...
    @Test
    @Transactional
    public void checkRestIsRequired() throws Exception {
        int databaseSizeBeforeTest = paymentRepository.findAll().size();
        // set the field null
        payment.setRest(null);
    ...
    public void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc.perform(get("/api/payments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].rest").value(hasItem(DEFAULT_REST.doubleValue())));
    }
    ...
    public void getPayment() throws Exception {
        ...
        restPaymentMockMvc.perform(get("/api/payments/{id}", payment.getId()))
            ...
            .andExpect(jsonPath("$.rest").value(DEFAULT_REST.doubleValue()));
    }
    ...
    public void updatePayment() throws Exception {
        ...
        assertThat(testPayment.getRest()).isEqualTo(UPDATED_REST);
    }
