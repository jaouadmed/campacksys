...
import ma.camerapack.campacksys.repository.ClientRepository;
...
import ma.camerapack.campacksys.domain.enumeration.ClientType;
/**
...
public class ClientResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "[@4J.9 ";
    private static final String UPDATED_EMAIL = "b@!.1e";

    private static final String DEFAULT_PHONE_NUMBER = "8556132738";
    private static final String UPDATED_PHONE_NUMBER = "1665883708";

    private static final ClientType DEFAULT_CLIENT_TYPE = ClientType.COMPANY;
    private static final ClientType UPDATED_CLIENT_TYPE = ClientType.INDIVIDUAL;
