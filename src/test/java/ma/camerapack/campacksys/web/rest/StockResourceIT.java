...
public class StockResourceIT {
    ...
    private static final Long DEFAULT_ALERT_LIMIT = 0L;
    private static final Long UPDATED_ALERT_LIMIT = 1L;
    private static final Long SMALLER_ALERT_LIMIT = 0L - 1L;
    ...
    public static Stock createUpdatedEntity(EntityManager em) {
        Stock stock = new Stock()
            ...
            .alertLimit(UPDATED_ALERT_LIMIT);
        return stock;
    }
    ...
    public void createStock() throws Exception {
        ...
        assertThat(testStock.getAlertLimit()).isEqualTo(DEFAULT_ALERT_LIMIT);
    }
    ...
    @Test
    @Transactional
    public void checkAlertLimitIsRequired() throws Exception {
        int databaseSizeBeforeTest = stockRepository.findAll().size();
        // set the field null
        stock.setAlertLimit(null);
    ...
    public void getAllStocks() throws Exception {
        ...
        restStockMockMvc.perform(get("/api/stocks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].alertLimit").value(hasItem(DEFAULT_ALERT_LIMIT.intValue())));
    }
    ...
    public void getStock() throws Exception {
        ...
        restStockMockMvc.perform(get("/api/stocks/{id}", stock.getId()))
            ...
            .andExpect(jsonPath("$.alertLimit").value(DEFAULT_ALERT_LIMIT.intValue()));
    }
    ...
    public void updateStock() throws Exception {
        ...
        assertThat(testStock.getAlertLimit()).isEqualTo(UPDATED_ALERT_LIMIT);
    }
