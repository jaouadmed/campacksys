...
import { OrderStockComponent } from 'app/entities/order-stock/order-stock.component';
...
describe('Component Tests', () => {
  describe('OrderStock Management Component', () => {
    let comp: OrderStockComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OrderStockComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.orderStocks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
