...
import { IAlert, Alert, AlertState } from 'app/shared/model/alert.model';
...
describe('Service Tests', () => {
  describe('Alert Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Alert(0, currentDate, AlertState.CREATED);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Alert', async () => {
        const returnedFromService = Object.assign(
          {
            date: currentDate.format(DATE_TIME_FORMAT),
            state: 'BBBBBB'
