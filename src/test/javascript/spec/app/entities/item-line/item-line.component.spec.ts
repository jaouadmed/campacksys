...
import { ItemLineComponent } from 'app/entities/item-line/item-line.component';
...
describe('Component Tests', () => {
  describe('ItemLine Management Component', () => {
    let comp: ItemLineComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ItemLineComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.itemLines[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
