...
import { IPayment, Payment, PaymentType, PaymentState } from 'app/shared/model/payment.model';
...
describe('Service Tests', () => {
  describe('Payment Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Payment(0, PaymentType.ONE_TIME, PaymentState.CREATED, 0, 0);
    });
