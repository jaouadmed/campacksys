...
describe('Product e2e test', () => {
  ...
  it('should load Products', async () => {
    ...
    expect(await productComponentsPage.getTitle()).to.eq('campacksysApp.product.home.title');
  });
  ...
  it('should load create Product page', async () => {
    ...
    expect(await productUpdatePage.getPageTitle()).to.eq('campacksysApp.product.home.createOrEditLabel');
  ...
  it('should create and save Products', async () => {
    ...
    await promise.all([
      ...
      productUpdatePage.setBarCodeInput('5'),
      productUpdatePage.setBuyingPriceInput('5'),
    ...
    expect(await productUpdatePage.getBarCodeInput()).to.eq('5', 'Expected barCode value to be equals to 5');
    expect(await productUpdatePage.getBuyingPriceInput()).to.eq('5', 'Expected buyingPrice value to be equals to 5');
    expect(await productUpdatePage.getSellingPriceInput()).to.eq('5', 'Expected sellingPrice value to be equals to 5');
  ...
  it('should delete last Product', async () => {
    ...
    expect(await productDeleteDialog.getDialogTitle()).to.eq('campacksysApp.product.delete.question');
